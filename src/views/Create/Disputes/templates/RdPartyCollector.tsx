...
const RdPartyCollectorTemplate = ({ index, disputeId }: TDisputeTemplate) => {
    ...
    >
      <Box wid="100%" justifyContent="space-between">
        <Box wid="50%" flexDirection="column" alignItems="flex-start">
          <Box display="none">
            <InputText defaultValue={"3rd Party Collector"} />
          </Box>
          <Text
        ...
        >
          ...
          {!reverse ? (
            <SelectText
              ...
              options={ActionByType("3rd Party Collector")}
              marginLeft={10}
              onChange={(e) =>
                setObject((prev) => ({
                  ...prev,
            ...
            <SelectText
              ...
              options={JustifyerByType("3rd Party Collector")}
              marginLeft={10}
              onChange={(e) =>
                setObject((prev) => ({
                  ...prev,
      ...
      >
        <Button
          ...
          onClick={() => duplicateDispute("3rd Party Collector", disputeId)}
        >
...
export default RdPartyCollectorTemplate;
