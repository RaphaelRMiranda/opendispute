...
const StudentLoansTemplate = ({ index, disputeId }: TDisputeTemplate) => {
    ...
    >
      <Box wid="100%" justifyContent="space-between">
        <Box wid="50%" flexDirection="column" alignItems="flex-start">
          <Box display="none">
            <InputText defaultValue={"Student Loans"} />
          </Box>
          <Text
        ...
        >
          ...
          {!reverse ? (
            <SelectText
              ...
              options={ActionByType("Student Loans")}
              marginLeft={10}
              onChange={(e) =>
                setObject((prev) => ({
                  ...prev,
            ...
            <SelectText
              ...
              options={JustifyerByType("Student Loans")}
              marginLeft={10}
              onChange={(e) =>
                setObject((prev) => ({
                  ...prev,
      ...
      >
        <Button
          ...
          onClick={() => duplicateDispute("Student Loans", disputeId)}
        >
...
export default StudentLoansTemplate;
