    ...
    >
      <Box wid="100%" justifyContent="space-between">
        <Box wid="50%" flexDirection="column" alignItems="flex-start">
          <Box display="none">
            <InputText defaultValue={"Debt Buyers"} />
          </Box>
          <Text
        ...
        >
          ...
          {!reverse ? (
            ...
            <SelectText
              ...
              options={
                JustifyerByType(settings.justifyers, "Debt Buyers") || []
              }
              marginLeft={10}
              onChange={(e) =>
                setObject((prev) => ({
      ...
      >
        <Button
          ...
          onClick={() => duplicateDispute("Debt Buyers", disputeId)}
        >
...
export default DebtBuyersTemplate;
