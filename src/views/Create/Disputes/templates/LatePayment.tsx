      ...
      setObject((prev) => ({
        ...
        dispute: prev.dispute.map((item, i) =>
          i === index
            ? {
                ...item,
                action: ActionByType(settings.actions, "Late Payment")[0].value,
    ...
    >
      <Box wid="100%" justifyContent="space-between">
        <Box wid="50%" flexDirection="column" alignItems="flex-start">
          <Box display="none">
            <InputText defaultValue={"Late Payment"} />
          </Box>
          <Text
        ...
        >
          ...
          {!reverse ? (
            ...
            <SelectText
              ...
              options={
                JustifyerByType(settings.justifyers, "Late Payment") || []
              }
              marginLeft={10}
              onChange={(e) =>
                setObject((prev) => ({
      ...
      >
        <Button
          ...
          onClick={() => duplicateDispute("Late Payment", disputeId)}
        >
...
export default LatePaymentTemplate;
