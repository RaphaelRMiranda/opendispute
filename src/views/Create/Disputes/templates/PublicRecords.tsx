...
const PublicRecordsTemplate = ({ index, disputeId }: TDisputeTemplate) => {
    ...
    >
      <Box wid="100%" justifyContent="space-between">
        <Box wid="50%" flexDirection="column" alignItems="flex-start">
          <Box display="none">
            <InputText defaultValue={"Public Records"} />
          </Box>
          <Text
        ...
        >
          ...
          {!reverse ? (
            <SelectText
              ...
              options={ActionByType("Public Records")}
              marginLeft={10}
              onChange={(e) =>
                setObject((prev) => ({
                  ...prev,
            ...
            <SelectText
              ...
              options={JustifyerByType("Public Records")}
              marginLeft={10}
              onChange={(e) =>
                setObject((prev) => ({
                  ...prev,
      ...
      >
        <Button
          ...
          onClick={() => duplicateDispute("Public Records", disputeId)}
        >
...
export default PublicRecordsTemplate;
